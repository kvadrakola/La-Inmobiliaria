...
export const agentFixtures = [
  {
    ...
    name: 'María García',
    role: 'Agente Senior',
    bio: 'Especialista en alquiler de larga duración con más de ocho años de experiencia en el mercado madrileño y andaluz.',
    contactPhone: '+34 600 111 222',
    contactEmail: 'maria.garcia@habitafactoria.es',
    portraitAssetId: 'media-agent-portrait-001',
  },
  {
    id: 'agent-002',
    name: 'Carlos López',
    role: 'Agente de Alquileres',
    bio: 'Gestiona la cartera de alquileres de temporada en la Comunidad de Madrid.',
    contactPhone: '+34 600 333 444',
    contactEmail: 'carlos.lopez@habitafactoria.es',
    portraitAssetId: 'media-agent-portrait-002',
  },
  {
    id: 'agent-003',
    name: 'Ana Martínez',
    role: 'Asesora Estudiantil',
    bio: 'Acompaña a estudiantes internacionales en Barcelona durante todo el proceso de alquiler.',
    contactPhone: '+34 600 555 666',
    contactEmail: 'ana.martinez@habitafactoria.es',
    portraitAssetId: 'media-agent-portrait-003',
  },
];
